...
//    private hardwareMap hardwareMap;
    ...
    public void init(Model modelType, String modelPath, String labelPath, Context ctx, Telemetry t) throws Exception{
    ...
    protected int getLayoutId() {
        return R.xml.tfe_ic_camera_connection_fragment;
    }
    ...
    protected void processImage() {
        ...
        //rgbFrameBitmap.setPixels(getRgbBytes(), 0, previewWidth,previewWidth/3 , previewHeight/3, previewWidth/3, previewHeight/3);
        //rgbFrameBitmap.setPixels(getRgbBytes(), 0, previewWidth,0 , 0, 220, 240);
