...
//        sleep(100);
            viper.setPower(-1*n);
            misumi.setPower(0.8);
            while((intakeExtEnc.getCurrentPosition()-intval)>=-760) {
//                if(((intakeExtEnc.getCurrentPosition()-intval)<=-700)){viper.setPower(0.5);}
                ...
                if((viper.getCurrentPosition()-vipval)<=-2020&&(viper.getCurrentPosition()-vipval)>=-2450){

                    viper.setPower(-0.4*n);
                }
                if((viper.getCurrentPosition()-vipval)<=-2400){
                ...
                if(misumiYES){
                    if(((misumiEnc.getCurrentPosition()-misval)<=-200)){
                        misumi.setPower(-0.1);
                    }
                    else
...
//        misumi.setPower(-0.1);
        ...
        viper.setPower(-1*n);
        while((viper.getCurrentPosition()-vipval)>=-2400){
...
//                telemetry.addData("misumi",misumiEnc.getCurrentPosition()-misval);
            ...
            misumi.setPower(0.1);
            intakeTurn.setPosition(0.3085);
            intakeExt.setPower(1);
            while((intakeExtEnc.getCurrentPosition() - intval) <= -13) {
...
//                telemetry.addData("misumi",misumiEnc.getCurrentPosition()-misval);
            ...
            if(i==4){
                ...
                intakeExt.setPower(0.0);
                viper.setPower(-1*n);
                while ((viperEnc.getCurrentPosition() - vipval) > -2400){}
                viper.setPower(0.0);
                sleep(30);
            ...
            while ((viperEnc.getCurrentPosition() - vipval) > -2400) {
                ...
                while ((intakeExtEnc.getCurrentPosition() - intval) >= -995) {
